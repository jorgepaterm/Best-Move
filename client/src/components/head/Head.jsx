            ...
            <div className={s.head}>
                ...
                ?  (
                    <div className={s.enlaces}>
                        <ul className={s.ul}>
                            <li className={s.li}><NavLink className={s.enlace} onClick={onClickTraerNotif} to='/home'>HOME</NavLink></li>
                            <li className={s.li}><NavLink className={s.enlace} onClick={onClickTraerNotif} to='/quienes-somos'>QUIENES SOMOS</NavLink></li>
                            {decodedToken?.usuario.role === 'user' && <li className={s.li} onClick={onClickTraerNotif} ><NavLink className={s.enlace} to='/por-que-registrarme'>¿POR QUÉ REGISTRARME?</NavLink></li>}
                            <li className={s.li}><NavLink className={s.enlace} onClick={onClickTraerNotif} to='/datos-del-dia'>DATOS DEL DÍA</NavLink></li>
                            ...
                            {decodedToken?.usuario.role === 'admin' && <li className={s.li} onClick={onClickTraerNotif} ><NavLink className={s.enlace} to='/agregar-dato'>AGREGAR DATO</NavLink></li>}
                            {decodedToken?.usuario.role === 'admin' && <li className={s.li} onClick={onClickTraerNotif} ><NavLink className={s.enlace} to='/tabla-usuarios'>TABLA USUARIOS</NavLink></li>}
                        </ul>
